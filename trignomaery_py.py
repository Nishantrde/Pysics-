...
fps = 30
output_filename = 'pygame_recording.mp4'
...
while running:
    ...
    # Capture the screen as an image for the video
    frame = pygame.surfarray.array3d(screen)  # Get the screen data
    frame = np.rot90(frame)  # Rotate the frame for OpenCV
